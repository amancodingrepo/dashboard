...
async function handleQueryFallback(query) {
    ...
    try {
        ...
        if ((error === null || error === void 0 ? void 0 : error.code) === "P1001" ||
            ((_b = error === null || error === void 0 ? void 0 : error.message) === null || _b === void 0 ? void 0 : _b.includes("connect")) ||
            ((_c = error === null || error === void 0 ? void 0 : error.message) === null || _c === void 0 ? void 0 : _c.includes("database"))) {
            throw error;
        }
        return null;
    }
    ...
    try {
        ...
        if (!vanna_base_url) {
            ...
            try {
                ...
                console.error("Error details:", {
                    message: fallbackError === null || fallbackError === void 0 ? void 0 : fallbackError.message,
                    code: fallbackError === null || fallbackError === void 0 ? void 0 : fallbackError.code,
                    name: fallbackError === null || fallbackError === void 0 ? void 0 : fallbackError.name,
                    stack: fallbackError === null || fallbackError === void 0 ? void 0 : fallbackError.stack,
                });
                // Check if it's a database connection error
                const isDbError = ((_a = fallbackError === null || fallbackError === void 0 ? void 0 : fallbackError.code) === null || _a === void 0 ? void 0 : _a.startsWith("P")) ||
                    ((_b = fallbackError === null || fallbackError === void 0 ? void 0 : fallbackError.message) === null || _b === void 0 ? void 0 : _b.toLowerCase().includes("connect")) ||
                    ((_c = fallbackError === null || fallbackError === void 0 ? void 0 : fallbackError.message) === null || _c === void 0 ? void 0 : _c.toLowerCase().includes("database")) ||
                    ((_d = fallbackError === null || fallbackError === void 0 ? void 0 : fallbackError.message) === null || _d === void 0 ? void 0 : _d.toLowerCase().includes("prisma"));
                return res.status(200).json({
                    error: isDbError
                        ? "Database connection error"
                        : "Query processing error",
                    answer: isDbError
                        ? "Unable to connect to the database. Please check your database configuration and try again later."
                        : "Unable to process your query. Please try again later or contact support.",
                    sql: null,
                    results: [],
                    success: false,
                });
        ...
        try {
            ...
            const vannaResults = Array.isArray(vannaData.results)
                ? vannaData.results
                : [];
            const response = {
            ...
            console.error("Vanna service error, trying fallback:", {
                ...
                status: (_f = e.response) === null || _f === void 0 ? void 0 : _f.status,
            });
            ...
            if (e.code === "ECONNABORTED" || ((_g = e.message) === null || _g === void 0 ? void 0 : _g.includes("timeout"))) {
                errorMsg = `Vanna AI service timeout: ${e.message}`;
                userMessage =
                    "The AI service is taking too long (possibly waking up). Try asking: 'Show top vendors', 'Total spend', or 'Overdue invoices'.";
            }
            else if (e.code === "ECONNREFUSED" || e.code === "ENOTFOUND") {
                errorMsg = `Cannot connect to Vanna AI service: ${e.message}`;
                userMessage =
                    "The AI service is currently unavailable. Try asking: 'Show top vendors', 'Total spend', or 'Overdue invoices'.";
            }
            else if (((_h = e.response) === null || _h === void 0 ? void 0 : _h.status) === 500) {
                ...
                userMessage =
                    "The AI service has an internal error. Try asking: 'Show top vendors', 'Total spend', or 'Overdue invoices'.";
            }
            else if ((_l = e.response) === null || _l === void 0 ? void 0 : _l.status) {
                errorMsg = `Vanna AI service error (${e.response.status}): ${((_o = (_m = e.response) === null || _m === void 0 ? void 0 : _m.data) === null || _o === void 0 ? void 0 : _o.error) || e.message}`;
                userMessage = "The AI service returned an error. Please try again.";
            }
            else {
                errorMsg =
                    ((_q = (_p = e.response) === null || _p === void 0 ? void 0 : _p.data) === null || _q === void 0 ? void 0 : _q.detail) ||
                        ((_s = (_r = e.response) === null || _r === void 0 ? void 0 : _r.data) === null || _s === void 0 ? void 0 : _s.error) ||
                        e.message ||
                        String(e);
            }
            res.status(500).json({
        ...
        console.error("Error stack:", outerError === null || outerError === void 0 ? void 0 : outerError.stack);
        console.error("Error details:", {
            message: outerError === null || outerError === void 0 ? void 0 : outerError.message,
            name: outerError === null || outerError === void 0 ? void 0 : outerError.name,
            code: outerError === null || outerError === void 0 ? void 0 : outerError.code,
        });
        // Try one more fallback attempt
        try {
            const finalFallback = await handleQueryFallback(((_t = req.body) === null || _t === void 0 ? void 0 : _t.query) || "");
        ...
        res.status(500).json({
            error: process.env.NODE_ENV === "production"
                ...
                : (outerError === null || outerError === void 0 ? void 0 : outerError.message) || "An unexpected error occurred",
